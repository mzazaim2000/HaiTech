              ...
              <div class="card-body">
                  <form>
                      ...
                      <div class="row gx-3 mb-3">
                          ...
                          <!-- Form Group (birthday)-->
                          <div class="col-md-6">
                              <label class="small mb-1" class="field input-field" for="inputPassword">Password</label>
                              <input class="form-control" id="inputPassword" type="text" name="birthday" placeholder="Enter new password" value="1234">
